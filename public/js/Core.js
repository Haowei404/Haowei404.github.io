...
window.onload = function () {
	...
	try {
		...
		function StartGame() {
			...
			document.title = "haowei魔塔& " + Version;
			var Hero = new Object();
			Hero["Name"] = "勇士";
			Hero["HP"] = 1000;
			Hero["ATK"] = 10;
			...
			function CreateEventControl(EnemyData, callback) {
				...
				e.SaveGame = function (Choose, callback) {
					...
					if (window.localStorage) {
						...
						var SaveData = {
							"HeroName": Hero["Name"], "Floor": Floor, "HP": Hero["HP"], "ATK": Hero["ATK"], "DEF": Hero["DEF"], "Gold": Hero["Gold"], "Exp": Hero["Exp"],
			...
			LoadResource(ResPath, ResNameList, function () {
				...
				var FloorIndex = Event.FindFloor(StartFloor);//获取当前楼层所有信息
